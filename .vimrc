...
"Teste (André que colocou qualquer coisa tira

Plug 'junegunn/fzf', { 'do': { -> fzf#install() } }

Plug 'junegunn/fzf.vim'

Plug 'tpope/vim-surround' "tem que configurar, eu acho...
Plug 'scrooloose/syntastic' " It runs files through external syntax checkers and displays any resulting
                            "errors to the user. This can be done on demand, or automatically as files are saved. 
                            "If syntax errors are detected, the user is notified and is happy because they didn't 
                            "have to compile their code or execute their script to find them.

" Incluido dia 4/07/2020 {Tudo relacionado ao neoclide/coc.vim}                            
...
"" Basic Setup
"*****************************************************************************"
"From https://vimrc-builder.now.sh/ ideas
"
...
if !exists('g:airline_powerline_fonts')
 ...
 let g:languagetool_jar='/home/duxiaoan/LanguageTool-5.0/languagetool-commandline.jar'
